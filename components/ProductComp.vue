        ...
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="px-5 pb-5 dark:text-white">
                ...
                <div class="flex items-center justify-end">
                    <button  v-if="alreadyInCart(cart, product) && user" class="text-white bg-gray-400 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                        <span class="text-xl font-bold  dark:text-white">Item Added</span>
                    </button>
                    <button v-else @click="addToCart(product)" class="text-white bg-yellow-400 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
