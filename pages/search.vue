...
<template>
	<div class="p-6 mt-14">
		...
		<div v-if="searcResults">
			<div
				class="mb-3 text-2xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white"
			>
				搜尋結果為：
			</div>
			<div class="grid grid-cols-4 gap-4">
				<div v-for="pro in searcResults">
		...
		<div v-if="searcResults && !searcResults.length">
			<div
				class="text-center mb-8 text-2xl font-extrabold leading-none tracking-tight text-gray-300 dark:text-white"
			>
				沒有結果
			</div>
		</div>
