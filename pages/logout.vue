...
<template>
    <div class="p-20 text-center">
        ...
        <NuxtLink @click="logout()" class="mb-12  md:mr-10  inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-800 dark:text-white rounded-lg hover:text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900  md:mb-20">
            Yes, log me out
