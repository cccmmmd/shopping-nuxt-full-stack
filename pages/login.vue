...
<template>
    <div>
        <div class="text-center mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900  dark:text-white">登入帳號</div>
        <form @submit.prevent="login" class="max-w-sm mx-auto">
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 me-2 mb-2">Log in</button>
        </form>
        <div class="max-w-sm mx-auto mt-4">
            <div>
            <!-- <div class=" grid grid-cols-1 md:grid-cols-2"> -->
                <!-- <button @click="githubLogin" type="button" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
                ...
                <button @click="googleLogin" type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5  w-full sm:w-auto inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
