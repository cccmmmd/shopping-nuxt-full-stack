            ...
            <div class=" bg-white rounded-lg shadow dark:bg-gray-800 p-5">
                ...
                <div class="pb-5 dark:text-white">
                    ...
                    <div class="flex items-center justify-end">
                        <button @click="addToCart(data)" class="text-white bg-yellow-400 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            <span v-if="alreadyInCart(cart, data) && user" class="text-xl font-bold  dark:text-white">Item Added</span>
